...
const Home = () => {
  ...
  return (
    <>
      <ToastContainer />
      <div className=" text-center mx-auto xx" style={{ width: "1200px" }}>
        <div className="row d-flex justify-content-center align-items-center">
          {recipe.map((data) => (
            <div key={data._id} className="col-md-3 my-3 mycard">
              <div
                className="card  text-light cards"
                style={{ width: "18rem" }}
              >
                ...
                <div className="card-body">
                  <h5 className="card-title namehome">{data.title}</h5>
                  <div className="my-3">
