...
const Fetchforedit = ({ id }) => {
  ...
  useEffect(() => {
    const fetchRecipe = async (id) => {
      ...
      setediting(result.data.recipe.ingredients)
  ...
  return (
    ...
    (<div className="text-center cont">
      ...
      {location.pathname !== "/saved" && (
        <>   <div>
            <label for="ingrediants"><strong className="instru">Ingredients:</strong></label>
            <br />
            <textarea className="editdetails" id="ingredients" name="ingredients" value={editing} onChange={(e)=>setediting(e.target.value)}></textarea>
            <br />
